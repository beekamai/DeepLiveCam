        ...
        if state and frame_processor not in current_processor_names:
            ...
            try:
                ...
                if module_to_remove:
                    ...
                    # Free the model's VRAM — the module object stays in
                    # sys.modules and would otherwise hold its session forever.
                    if hasattr(module_to_remove, 'release'):
                        module_to_remove.release()
