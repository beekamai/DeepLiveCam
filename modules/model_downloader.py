...
FF_ASSETS_BASE = "https://github.com/facefusion/facefusion-assets/releases/download/"

# Models that do not live in the Deep-Live-Cam HF repo get an explicit source.
MODEL_URLS: Dict[str, str] = {
    "gpen_bfr_1024.onnx": FF_ASSETS_BASE + "models-3.0.0/gpen_bfr_1024.onnx",
    "gpen_bfr_2048.onnx": FF_ASSETS_BASE + "models-3.0.0/gpen_bfr_2048.onnx",
    "codeformer.onnx": FF_ASSETS_BASE + "models-3.0.0/codeformer.onnx",
    "restoreformer_plus_plus.onnx": FF_ASSETS_BASE + "models-3.0.0/restoreformer_plus_plus.onnx",
    "gfpgan_1.4.onnx": FF_ASSETS_BASE + "models-3.0.0/gfpgan_1.4.onnx",
    "hyperswap_1a_256.onnx": FF_ASSETS_BASE + "models-3.3.0/hyperswap_1a_256.onnx",
    "hyperswap_1b_256.onnx": FF_ASSETS_BASE + "models-3.3.0/hyperswap_1b_256.onnx",
    "hyperswap_1c_256.onnx": FF_ASSETS_BASE + "models-3.3.0/hyperswap_1c_256.onnx",
    "alphaface_256.onnx": FF_ASSETS_BASE + "models-3.9.0/alphaface_256.onnx",
    "xseg_3.onnx": FF_ASSETS_BASE + "models-3.2.0/xseg_3.onnx",
}
...
MODEL_SIZES: Dict[str, int] = {
    ...
    "gpen_bfr_1024.onnx": 285203703,
    "gpen_bfr_2048.onnx": 285582766,
    "codeformer.onnx": 376951650,
    "restoreformer_plus_plus.onnx": 294264232,
    "gfpgan_1.4.onnx": 340299087,
    "hyperswap_1a_256.onnx": 402742682,
    "hyperswap_1b_256.onnx": 402742682,
    "hyperswap_1c_256.onnx": 402742682,
    "alphaface_256.onnx": 555624110,
    "xseg_3.onnx": 70327709,
...
def resolve_url(name: str) -> str:
    ...
    override = MODEL_URLS.get(name)
    if override is not None:
        return override
    return HF_RESOLVE_BASE + name
